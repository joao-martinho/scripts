...
repositorios=(
	"https://github.com/j-martinho/scripts.git|/home/joao/Área de trabalho/Scripts"
	"https://github.com/j-martinho/pagina-pessoal.git|/home/joao/Área de trabalho/Página pessoal"
)
